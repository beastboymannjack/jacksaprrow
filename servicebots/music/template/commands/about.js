...
module.exports = {
  ...
  description: 'Shows information about deadloom Music',
  ...
  async execute(message) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setImage("https://cdn.discordapp.com/attachments/1414256936374497376/1430798331524808724/standard_2.gif")
